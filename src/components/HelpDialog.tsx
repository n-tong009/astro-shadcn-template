        ...
        <div className='grid gap-4 py-4'>
          <div className='space-y-2'>
            ...
            <ul className='list-disc pl-5 space-y-1'>
              <li>
                リポジトリをクローン
                <code className='bg-muted px-1.5 py-0.5 rounded text-sm ml-2'>git clone [repository-url]</code>
              </li>
              <li>
                依存関係をインストール
          ...
          <div className='space-y-2'>
            ...
            <ul className='list-disc pl-5 space-y-1'>
              <li>
                ...
                <span className='text-sm text-muted-foreground block ml-2'>http://localhost:3000 で起動</span>
              </li>
              <li>
                <em>ステージング</em>: npm run stg
                <span className='text-sm text-muted-foreground block ml-2'>ステージング環境用のビルドを生成</span>
              </li>
              <li>
                <em>本番環境</em>: npm run prod
                <span className='text-sm text-muted-foreground block ml-2'>最適化された本番用ビルドを生成</span>
              </li>
            </ul>
          </div>
